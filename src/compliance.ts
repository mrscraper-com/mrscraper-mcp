export const MANUAL_SCRAPER_COMPLIANCE_WARNING = `### Compliance & Legal Risk
WARNING
...
export const MANUAL_SCRAPER_AGENT_COMPLIANCE_NOTES = `Agent compliance (manual scrapers):
- Before the FIRST call to any manual scraper tool in this conversation, show the user this warning exactly once and wait for acknowledgment. Do not call manual scraper tools until the user accepts the risk.
- Do not repeat this warning on later manual scraper calls in the same conversation.

${MANUAL_SCRAPER_COMPLIANCE_WARNING}`;

export const MANUAL_SCRAPER_SERVER_INSTRUCTIONS =
  "Before the first manual scraper tool call in a conversation, agents must show the Compliance & Legal Risk warning once and obtain user acknowledgment; do not repeat the warning on later manual scraper calls.";
